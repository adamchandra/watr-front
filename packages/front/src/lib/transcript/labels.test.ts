...
import {
  Label, LabelRepr, Range, RangeRepr,
} from './labels';
...
describe('Label/Range IO', () => {
  ...
  it('should I/O Range/Reprs', () => {
    const examples: any[] = [
      ...
      { unit: 'page', at: 1 },
      { unit: 'shape', at: [[8454, 8483], [52_586, 8483]] },
      { unit: 'stanza', at: 0 },
      { unit: 'text:line', at: [1, 2] },
      { unit: 'text:char', at: [1, 2] },
      { unit: 'document', at: 'Doc#23' },
      { unit: 'label', at: 32 },
      { unit: 'shape', at: [36_184, 46_472, 1255, 924] },
    ];
  ...
  it('should I/O Labels/Reprs', () => {
    const examples: any[] = [
      ...
      { range: [{ unit: 'shape', at: [36_184, 46_472, 1255, 924] }], name: 'HorizonRect' },
  ...
  it('should I/O Nested Labels', () => {
    const examples: any[] = [
      {
        name: 'Authors',
        range: [{ unit: 'stanza', at: 21 }],
        children: [
          {
            name: 'Authors',
            range: [{ unit: 'text:line', at: [0, 2] }],
            children: [
              {
                name: 'Author',
                range: [{ unit: 'text:char', at: [0, 20] }],
                children: [
