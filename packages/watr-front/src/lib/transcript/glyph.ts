...
const decodeGlyphProps: (unk: unknown, ctx: io.Context) => E.Either<io.Errors, GlyphProps> = (unk: unknown, ctx: io.Context) => {
...
export const GlyphProps: io.Type<GlyphProps, GlyphPropsRepr, unknown> = new io.Type<GlyphProps, GlyphPropsRepr, unknown>(
  'GlyphProps',
...
export const Glyph: io.Type<Glyph, GlyphRepr, unknown> = new io.Type<Glyph, GlyphRepr, unknown>(
  'Glyph',
  (a: any): a is Glyph => io.string.is(a.char)
